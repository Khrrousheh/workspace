...
def calculates_results_stats(results_dic):
    ...
    Z, A, B, C, D, E, Y = len(results_dic), 0, 0, 0, 0, 0, 0
    for value in results_dic.values():
        A += 1 if (value[3] == 1 and value[4] == 1) else 0
        B += 1 if value[3] == 1 else 0
        C += 1 if (value[3] == 0 and value[4] == 0) else 0
        D += 1 if value[3] == 0 else 0
        E += 1 if (value[3] == 1 and value[2] == 1) else 0
        Y += 1 if value[2] == 1 else 0
